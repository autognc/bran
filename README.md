...
10. run the following command to start tensorboard: `nohup tensorboard --logdir=/home/ubuntu/.ravenML/tf-bbox/temp/models/model &`
11. nagivate to `<ip_of_ec2_instance>:6006` in your browser to see tensorboard